...
import com.demo.view.business.BusinessGridAdapter;
import com.demo.view.business.BusinessGridView;
...
public class BusinessFragment extends BaseFragment {
	...
	private BusinessGridView gridview;
	...
	private void initView(View view) {
		gridview = (BusinessGridView) view.findViewById(R.id.gridview);
		gridview.setAdapter(new BusinessGridAdapter(getActivity()));
		// 添加消息处理
